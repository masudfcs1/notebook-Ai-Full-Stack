  ...
  return (
    <div className="mx-auto max-w-6xl space-y-5">
      ...
      <motion.div
        ...
        className="flex flex-col gap-4 rounded-2xl border border-rose-500/20 bg-linear-to-r from-rose-500/10 via-orange-500/5 to-transparent p-4 backdrop-blur-sm md:flex-row md:items-center md:justify-between"
      >
        <div className="flex items-center gap-3">
          <div className="relative flex h-11 w-11 items-center justify-center rounded-xl bg-linear-to-r from-rose-500 to-orange-500 text-white shadow-lg shadow-rose-500/30">
...
• Use timestamps like [10:32] for key moments`}
        ...
        <div className="space-y-5">
          ...
          <Card className="border-indigo-500/20 bg-linear-to-r from-indigo-500/10 to-violet-500/5 p-5 backdrop-blur-sm">
            <div className="mb-3 flex items-center gap-2">
              <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-linear-to-r from-indigo-500 to-violet-500 text-white shadow-md">
            ...
            <Button
              ...
              className="w-full gap-2 rounded-xl bg-linear-to-r from-indigo-500 to-violet-500 text-white shadow-md shadow-indigo-500/25 hover:opacity-95 disabled:opacity-50"
            >
              {summarizing ? (
                <>
                  <span
