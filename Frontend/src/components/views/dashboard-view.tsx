...
const QUICK_ACTIONS = [
  {
    label: "Upload Notes",
    desc: "Drop a file or paste text",
    icon: Upload,
  ...
  },
  {
    ...
    desc: "See your task board",
    icon: ListChecks,
    gradient: "from-emerald-500 to-teal-500",
    view: "action-items" as const,
  },
  {
    label: "Start Live Meeting",
    desc: "Capture notes in real-time",
    icon: Zap,
    gradient: "from-rose-500 to-orange-500",
    view: "ongoing" as const,
  },
];
          ...
          return (
            ...
            >
              <Card className="dashboard-glass-card dashboard-stat-card group relative overflow-hidden rounded-2xl p-5">
                <div
                  className={cn(
                    "absolute -right-6 -top-6 h-20 w-20 rounded-full bg-linear-to-r opacity-20 blur-2xl transition-opacity group-hover:opacity-40",
                    card.gradient,
                  )}
                />
                <div className="relative flex items-start justify-between">
                  <div
                    className={cn(
                      "flex h-11 w-11 items-center justify-center rounded-xl bg-linear-to-r text-white shadow-lg",
                      card.gradient,
                      card.glow,
                    )}
                  >
                  ...
                  <Badge
                    variant="secondary"
                    className="gap-1 bg-emerald-500/10 px-1.5 py-0.5 text-[10px] font-semibold text-emerald-600 dark:text-emerald-400"
                  >
          ...
          <div className="mb-4 flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Latest meeting notes & summaries
              </p>
            </div>
            <Button
              variant="ghost"
                ...
                return (
                  <motion.button
                    ...
                    onClick={() => {
                      ...
                      dispatch(
                        setView(
                          note.status === "summarized" ? "summary" : "upload",
                        ),
                      );
                    }}
            ...
            <div className="grid grid-cols-2 gap-2.5">
              {QUICK_ACTIONS.map((a) => (
                ...
                >
                  <div
                    className={cn(
                      "flex h-8 w-8 items-center justify-center rounded-lg bg-linear-to-r text-white shadow-sm",
                      a.gradient,
                    )}
                  >
              ...
              {weekly.map((w, i) => (
                ...
                >
                  <motion.div
                    ...
                    className="w-full rounded-t-md bg-linear-to-r from-indigo-500 to-violet-400"
                    style={{ minHeight: 6 }}
                  />
