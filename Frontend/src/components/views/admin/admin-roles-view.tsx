              ...
              >
                <div className="flex items-stretch">
                  ...
                  <div className="flex flex-1 items-center gap-4 p-5">
                    {/* Icon */}
                    <div className={`flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br ${role.color} text-white shadow-lg`}>
                ...
                {/* Decorative gradient */}
                <div className={`absolute -right-8 -top-8 h-24 w-24 rounded-full bg-gradient-to-br ${role.color} opacity-[0.04] blur-2xl`} />
              </Card>
        ...
        <Card className="border-white/5 bg-white/[0.02] p-6 backdrop-blur-sm">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-xs">
              ...
              <tbody>
                {[
                  { perm: "Manage all users", roles: [true, true, false, false, false] },
                  { perm: "Assign roles", roles: [true, false, false, false, false] },
                  { perm: "View user list", roles: [true, true, true, false, false] },
                  { perm: "Create users", roles: [true, true, false, false, false] },
                  { perm: "Delete users", roles: [true, false, false, false, false] },
                  { perm: "View activity log", roles: [true, true, true, false, false] },
                  { perm: "Manage workspaces", roles: [true, true, true, true, false] },
