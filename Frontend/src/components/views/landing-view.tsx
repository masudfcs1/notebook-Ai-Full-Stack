          ...
          <div className="relative mx-auto grid max-w-[1240] items-center gap-16 px-5 lg:grid-cols-[0.88fr_1.12fr] lg:gap-14 lg:px-8">
            ...
            >
              ...
              <div className="mt-9 flex flex-col gap-3 sm:flex-row">
                <Button
                  onClick={start}
                  className="landing-primary-button h-13 rounded-full px-7 text-[15px] font-semibold text-white"
                >
                  {isAuthenticated
                    ? "Open your workspace"
                ...
                <a
                  href="#product"
                  className="landing-glass-button group inline-flex h-13 items-center justify-center rounded-full px-6 text-[15px] font-semibold text-slate-800 dark:text-white"
                >
              ...
              {benefits.map((benefit, index) => (
                ...
                >
                  <div className="flex items-center justify-between">
                    <span
                      className={`grid h-12 w-12 place-items-center rounded-2xl bg-gradient-lr ${benefit.color} text-white shadow-lg shadow-blue-500/15 transition-transform duration-500 group-hover:rotate-3 group-hover:scale-105`}
                    >
        ...
        <section className="px-5 py-20 sm:py-28">
          ...
          >
            ...
            <div className="relative">
              ...
              <Button
                onClick={start}
                className="mt-8 h-13 rounded-full bg-white px-7 text-[15px] font-semibold text-slate-950 shadow-xl shadow-blue-950/20 transition hover:bg-blue-50"
              >
                {isAuthenticated
...
function InteractiveProductPreview() {
  ...
  return (
    ...
    >
      <div className="absolute -inset-8 rounded-[3rem] bg-gradient-lr from-blue-400/35 via-violet-400/20 to-cyan-300/30 blur-3xl dark:from-blue-600/30 dark:via-violet-600/20 dark:to-cyan-500/15" />
      <div className="landing-product-frame relative overflow-hidden rounded-[1.75rem]">
                  ...
                  >
                    {active && (
                      <motion.span
                        ...
                        className="absolute inset-0 bg-gradient-r from-blue-600 to-indigo-600"
                      />
                    )}
          ...
          <div className="min-w-0 bg-white/65 p-3.5 backdrop-blur-2xl dark:bg-[#0b1425]/80 sm:p-5">
            <div className="mb-4 flex items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="grid h-7 w-7 place-items-center rounded-full bg-gradient-lr from-violet-500 to-blue-600 text-[8px] font-bold text-white">
                  AM
                </span>
              </div>
            </div>
        ...
        <div className="absolute bottom-0 left-[58] right-0 h-0.5 bg-slate-100 dark:bg-white/5 sm:left-[158]">
          <motion.div
            ...
            className="h-full bg-gradient-r from-blue-500 to-violet-500"
          />
        </div>
      </div>
...
function PreviewPanel({ activeTab }: { activeTab: number }) {
  ...
  return (
    <div>
      <div className="mb-3 flex items-center justify-between rounded-xl bg-gradient-r from-blue-600 to-indigo-600 p-4 text-white">
        <div>
