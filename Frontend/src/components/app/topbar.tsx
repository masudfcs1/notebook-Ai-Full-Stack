...
import { Search, Menu, Sun, Moon, Command, Plus, Sparkles, X, Activity, Cpu } from "lucide-react"
...
const TITLES: Record<string, { title: string; subtitle: string; sysCode: string }> = {
