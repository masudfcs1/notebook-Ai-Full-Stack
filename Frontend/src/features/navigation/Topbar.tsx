        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-2">
            ...
            <motion.h1
              ...
              className="truncate text-base font-semibold leading-tight tracking-[-0.025] md:text-lg"
            >
              {meta.title}
            </motion.h1>
          </div>
      ...
      <div className="flex items-center gap-2.5">
        ...
        <div className="relative hidden md:block">
          ...
          <Input
            ...
            className="h-10 w-52 rounded-xl border border-border/60 bg-white/45 pl-9 pr-14 text-xs shadow-sm transition-all duration-300 focus:border-indigo-500/35 focus:bg-white/75 focus:shadow-[0_10px_30px_-18px_rgba(79,70,229,0.45)] dark:bg-white/35 dark:focus:bg-white/6 lg:w-64"
          />
          {searchQuery ? (
            <button
            ...
            <kbd className="pointer-events-none absolute right-2.5 top-1/2 hidden -translate-y-1/2 select-none items-center gap-0.5 rounded-md border border-border/60 bg-white/55 px-1.5 py-0.5 text-[9px] font-medium text-muted-foreground dark:bg-white/5 lg:flex">
        ...
        {isAuthenticated && user ? (
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button className="flex h-10 items-center gap-2 rounded-xl border border-border/60 bg-white/45 p-1.5 pr-2.5 shadow-sm transition-all hover:border-indigo-500/25 hover:bg-white/70 dark:bg-white/35 dark:hover:bg-white/6 cursor-pointer">
                ...
                <span className="hidden text-xs font-semibold text-foreground md:inline-block max-w-[72.5px] truncate">
                  {displayName}
                </span>
